<template>
  <div class="container">
    ...
    <div class="txtcenter ff-cabin-r head_ajak">
      <span class="c_hijau_perpus"
        >AYO BERGABUNG DENGAN PERPUSTAKAAN PRAXIS</span
      >
    </div>
      ...
      <div class="row mb-3 justify-content-center text-center">
        <div class="col-lg-10 mb-3">
          <h2 class="section-title-underline mb-3">
            <span class="text-white" style="font-size: 20pt"
              >E-resource Perpustakaan</span
            >
          </h2>
        </div>
      </div>
...
.f-cabin-r {
  font-family: "Cabin-Reguler", sans-serif;
}
.txtcenter {
  text-align: center;
}
